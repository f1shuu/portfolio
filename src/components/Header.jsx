...
export default function Header() {
    return (
        <>
            <div className='flex lg:justify-end justify-center items-center w-[100vw] lg:h-[10vh] md:h-[10vh] sm:h-[10vh] bg-[#4BB3FD] lg:px-20 md:px-10 sm:px-6 fixed shadow-lg z-40'>
                {buttonsData.map((element, index) => (
                    <button key={index} className='inline-flex items-center whitespace-nowrap relative border-none transition ease-in-out overflow-hidden lg:px-5 md:px-4 sm:px-3 px-2 py-3 group'>
                        ...
                        <span className='absolute left-1/2 transform -translate-x-1/2 bottom-0 w-0 h-1 bg-[#2A2D34] transition-all duration-500 ease-in-out group-hover:w-full' />
                    </button>
                ))}
                <button onClick={handleDownloadCV} className='inline-flex items-center whitespace-nowrap relative border-none transition ease-in-out overflow-hidden lg:px-5 md:px-4 sm:px-3 px-2 py-3 group'>
                    ...
                    <span className='absolute left-1/2 transform -translate-x-1/2 bottom-0 w-0 h-1 bg-[#4BB3FD] transition-all duration-500 ease-in-out group-hover:w-full' />
                </button>
            </div>
        </>
    )
